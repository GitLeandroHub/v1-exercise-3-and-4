...
//BUILD_DUMMY_WASM_BINARY= cargo expand -p pallet-template > template2.rs
        ...
        AccountId: _parity_scale_codec::Decode,
    {
        fn decode<__CodecInputEdqy: _parity_scale_codec::Input>(
            ...
            match __codec_input_edqy.read_byte()? {
                __codec_x_edqy if __codec_x_edqy == 0usize as u8 => Ok(RawEvent::SomethingStored(
                    {
...
const _: () = {
    ...
    impl<T: Trait> _parity_scale_codec::Decode for Call<T> {
        fn decode<__CodecInputEdqy: _parity_scale_codec::Input>(
            ...
            match __codec_input_edqy.read_byte()? {
                __codec_x_edqy if __codec_x_edqy == 0usize as u8 => Ok(Call::do_something({
                ...
                __codec_x_edqy if __codec_x_edqy == 1usize as u8 => Ok(Call::cause_error()),
